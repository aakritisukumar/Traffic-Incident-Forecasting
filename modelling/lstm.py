...
def plot_lstm_results(actual_exp, pred_exp):
...
def train_lstm_model(df, column='WERT_log', window_size=12,
    ...
    plot_lstm_results(actual_exp, pred_exp)
    plt.show()
...
if __name__ == "__main__":
    ...
    if 'WERT_log' not in df.columns:
        if 'WERT' in df.columns:
            ...
            raise ValueError("The dataset must have either 'WERT_log' or 'WERT' column.")
